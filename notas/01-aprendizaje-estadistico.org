...
- [[#qué-es-el-aprendizaje-estadístico][¿Qué es el aprendizaje estadístico?]]
  ...
  - [[#hay-una-f-que-sea-ideal][¿Hay una $f$ que sea ideal?]]
...
#+begin_src R :file img/sales.svg :results output graphics file :exports results
...
#+begin_src R :file img/loess.svg :exports results :results output graphics file
...
#+HEADER: :width 10 :height 5.5 :R-dev-args bg="transparent"
#+begin_src R :file img/lineal.svg :exports results :results output graphics file
...
#+REVEAL: split
#+HEADER: :width 10 :height 5.5 :R-dev-args bg="transparent"
#+begin_src R :file img/quadratic.svg :exports results :results output graphics file
...
#+REVEAL: split
#+HEADER: :width 10 :height 5.5 :R-dev-args bg="transparent"
#+begin_src R :file img/polinomial.svg :exports results :results output graphics file
...
#+HEADER: :width 10 :height 5.5 :R-dev-args bg="transparent"
#+begin_src R :file img/polyfit-single.svg :exports results :results output graphics file
...
#+begin_src org
                                        coef
(Intercept)                        0.4905712
poly(x, degree = m, raw = TRUE)1  13.0178070
poly(x, degree = m, raw = TRUE)2 -64.4863513
poly(x, degree = m, raw = TRUE)3  62.9424938
poly(x, degree = m, raw = TRUE)4  32.7114482
poly(x, degree = m, raw = TRUE)5 -75.0164005
poly(x, degree = m, raw = TRUE)6  32.2320558
#+end_src


#+begin_src R #+begin_src R :exports none :results none
...
#+HEADER: :width 10 :height 5.5 :R-dev-args bg="transparent"
#+begin_src R :file img/polyfit.svg :exports results :results output graphics file
...
#+HEADER: :width 10 :height 5.5 :R-dev-args bg="transparent"
#+begin_src R :file img/mse-polyfit.svg :exports results :results output graphics file 
...
#+RESULTS:
[[file:../img/mse-polyfit.svg]]

#+REVEAL: split
#+caption: Poco ruido
file:../img/mse-polyfit-noise.svg
