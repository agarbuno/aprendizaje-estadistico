...
\begin{enumerate}
    ...
    \item {\bf El predictor óptimo Bayesiano:} Muestra que para cualquier distirbución de probabilidad $\D,$ el predictor $f_\D$ es óptimo, en el sentido de que cualquier otro clasificador $g: \X \rightarrow \{0,1\},$ satisface $L_{\D}(f_{\D}) \leq L_{\D}(g).$
